...
public class TripSelection extends javax.swing.JFrame {

    /**
     * Creates new form PassengerAvaliability
     */
    public TripSelection(Driver driver, Origin origin) {
        initComponents();
        this.driver = driver;
        this.origin = origin;
        ...
        //Generate combobox fields
        if (availableTripList.isEmpty()) {
            String[] comboBoxModelArray = {"No trips found."};
            availablePassengers.setModel(new DefaultComboBoxModel(comboBoxModelArray));
            select.setVisible(false);
        } else {
            String[] comboBoxModelArray = new String[availableTripList.size()];
            for (int i = 0; i < comboBoxModelArray.length; i++) {
                comboBoxModelArray[i] = i + " " + availableTripList.get(i).getPassenger().getName().getFull();
            }
            availablePassengers.setModel(new DefaultComboBoxModel(comboBoxModelArray));
        }
    }
    ...
    private void initComponents() {
        ...
        availablePassengers = new javax.swing.JComboBox<>();
        ...
        jLabel1.setText("Availabile Trips");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(availablePassengers, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(availablePassengers, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void selectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectActionPerformed
        new TripConfirmation(driver, availableTripList.get(availablePassengers.getSelectedIndex())).setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TripSelection(new Driver(), new Origin()).setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox<String> availablePassengers;
    ...
    private ArrayList<Trip> availableTripList = new ArrayList<Trip>();
}
